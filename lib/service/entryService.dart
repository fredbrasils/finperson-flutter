...
class EntryService {
  var _allEntrys = <Entry>[
    ...
    Entry(
      id: 10,
      price: 120,
      data: DateTime.parse("2020-09-05 20:18:04Z"),
      type: EntryType.DISPENSE,
      category: CategoryService().loadCategoryById(9),
      description: 'Jean Coutu',
    ),
    Entry(
      id: 11,
      price: 2000.00,
      data: DateTime.parse("2020-09-05 21:00:00Z"),
      type: EntryType.REVENUE,
    ...
    Entry(
      id: 12,
      price: 700.00,
      data: DateTime.parse("2020-09-08 20:00:04Z"),
      type: EntryType.DISPENSE,
    ...
    Entry(
      id: 13,
      price: 250.00,
      data: DateTime.parse("2020-09-10 20:18:04Z"),
      type: EntryType.DISPENSE,
    ...
    Entry(
      id: 14,
      price: 87.00,
      data: DateTime.parse("2020-09-15 20:18:04Z"),
      type: EntryType.DISPENSE,
    ...
    Entry(
      id: 15,
      price: 35.00,
      data: DateTime.parse("2020-09-15 10:15:04Z"),
      type: EntryType.DISPENSE,
      category: CategoryService().loadCategoryById(7),
      description: 'MC Donalds',
    ),
    Entry(
      id: 16,
      price: 15.00,
      data: DateTime.parse("2020-09-17 15:12:04Z"),
      type: EntryType.DISPENSE,
      category: CategoryService().loadCategoryById(9),
      description: 'Jean Coutu',
    ),
    Entry(
      id: 17,
      price: 76.00,
      data: DateTime.parse("2020-09-18 09:18:04Z"),
      type: EntryType.DISPENSE,
    ...
    Entry(
      id: 18,
      price: 67.00,
      data: DateTime.parse("2020-09-20 19:20:04Z"),
      type: EntryType.DISPENSE,
      category: CategoryService().loadCategoryById(10),
      description: 'Rental cars',
    ),
    Entry(
      id: 19,
      price: 250.00,
      data: DateTime.parse("2020-09-25 17:18:04Z"),
      type: EntryType.DISPENSE,
      category: CategoryService().loadCategoryById(7),
      description: 'IGA',
    ),
