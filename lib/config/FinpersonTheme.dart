...
TextTheme _buildTextTheme(TextTheme base) {
  return base.copyWith(
    ...
    headline4: base.headline4.copyWith(
        fontSize: 14.0, fontFamily: 'Roboto-light', letterSpacing: 1.5),
    headline5: base.headline5.copyWith(fontSize: 18.0, fontFamily: 'Eczar'),
    headline6: base.headline6.copyWith(
        fontSize: 10.0, fontFamily: 'Roboto-light', letterSpacing: 1.5),
    subtitle1:
        base.subtitle1.copyWith(fontSize: 16.0, fontFamily: 'Roboto-regular'),
    subtitle2:
        base.subtitle2.copyWith(fontSize: 14.0, fontFamily: 'Roboto-light'),
    bodyText1: base.bodyText1.copyWith(fontSize: 16.0, fontFamily: 'Eczar'),
    bodyText2:
        base.bodyText2.copyWith(fontSize: 14.0, fontFamily: 'Roboto-light'),
    caption:
